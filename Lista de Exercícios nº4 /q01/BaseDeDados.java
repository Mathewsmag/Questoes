	...
	Contato buscar(String nome) {
		...
		for (int posicao = 0; posicao < contatos.length; posicao++) {
			...
			if (contatoPosicaoAtual == null)
				...
				System.out.println("Nome: " + contatoPosicaoAtual.getNome());
				System.out.println("Endereço: " + contatoPosicaoAtual.getEndereco());
				System.out.println("Telefone: " + contatoPosicaoAtual.getTelefone());
